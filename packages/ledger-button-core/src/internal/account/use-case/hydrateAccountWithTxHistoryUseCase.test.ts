...
import type { TransactionHistoryResult } from "@internal/transaction-history/model/transactionHistoryTypes";
...
import { HydrateAccountWithTxHistoryUseCase } from "./hydrateAccountWithTxHistoryUseCase";
