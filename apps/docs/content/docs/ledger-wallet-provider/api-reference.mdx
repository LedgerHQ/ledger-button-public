...
Initializes the Ledger Wallet Provider and injects the UI components into the DOM. Announces the Ledger wallet to every supported chain through its native discovery protocol: EVM dApps via [EIP-6963](https://eips.ethereum.org/EIPS/eip-6963), and Solana dApps via the [Wallet Standard](https://github.com/wallet-standard/wallet-standard). For chain-specific connect and signing examples, see [EVM](./evm) and [Solana](./solana).
